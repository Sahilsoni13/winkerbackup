...
const { isDarkMode } = useTheme();
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={keyboardOffset} // Adjusted offset for iOS
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={[{
          backgroundColor:isDarkMode ? colors.charcol100 : colors.white,
          flexGrow: 1,
          paddingBottom: keyboardOffset > 0 ? (isInputFocused ? 45 : 0) : (isInputFocused ? insets.bottom + 30 : 0), 
          ...
          <View style={{ paddingVertical: 10 }}>
            ...
            <View
              style={{
                ...
                marginBottom: keyboardOffset > 0 ? 0 : (isInputFocused ? -40 : 0),
